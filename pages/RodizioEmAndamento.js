...
const RodizioEmAndamento = ({navigation}) => {
  ...
  const finalizarRodizio = () => {
    console.log(local);
    postRodizio({local, listaParticipantes})
      ...
      <View style={styles.container}>
        <View style={styles.containerLocal}>
          <TextInput
            ...
            value={local}
            // ref={nomeInputRef}
            onChangeText={(textoDigitado) => setLocal(textoDigitado)}
          />
        </View>
...
export default RodizioEmAndamento;
